...
inquiry_options() {
  ...
  print_banner
  printf "${WHITE} 💻 Bem vindo(a) ao Kmenu 4.5, Selecione abaixo a proxima ação!${GRAY_LIGHT}"
  printf "\n\n"
  printf "   [1] Instalar Kmenu 4.5 \n"
  # printf "   [1] Atualizar Kmenu SaaS \n"
  printf "   [2] Deletar Kmenu 4.5 \n"
  printf "   [3] Bloquear Kmenu 4.5 \n"
  printf "   [4] Desbloquear Kmenu 4.5 \n"
  printf "   [5] Alter. dominio Kmenu 4.5 \n"
  printf "\n"
  read -p "> " option
